 ...
 * <A href="http://localhost:8080/hi">in your browser</A> and you'll be prompted
 * to supply a username and password. You can find some sample usernames and
 * passwords in {@code data.sql}. Similarly, if you try to
 * {@code curl http://localhost:8080/hi}, you'll be prompted for authentication
 * information.
 */
